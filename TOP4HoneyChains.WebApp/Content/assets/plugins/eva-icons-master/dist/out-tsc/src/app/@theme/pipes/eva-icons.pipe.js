...
var EvaIconsPipe = /** @class */ (function () {
    ...
    EvaIconsPipe.prototype.transform = function (icon, options) {
        var mergedOptions = __assign(__assign({}, this.defaultOptions), options);
        ...
        var animation = animationType ?
            ...
            null;
        return this.sanitizer.bypassSecurityTrustHtml(eva_1.icons[icon].toSvg({
            width: width,
            height: height,
            fill: fill,
            animation: animation,
